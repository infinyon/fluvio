...
impl K8WSUpdateService {
     ...
     pub async fn add<S>(
        ...
        value: KVObject<S>,
         ...
         where S: Spec + Debug + Into<<S as Spec>::K8Spec>,
            ...
            <<S as Spec>::K8Spec as K8Spec>::Status: Default + Debug + DeserializeOwned + Serialize + Clone + Send
    ...
    async fn update_status<S>(
        ...
        value: KVObject<S>,
         ...
         where S: Spec + Debug, 
            ...
            <<S as Spec>::K8Spec as K8Spec>::Status:  Default + Debug + Serialize + DeserializeOwned + Send + Sync
    ...
    pub async fn update_spec<S>(
        ...
        value: KVObject<S>,
         ...
         where 
            ...
            <<S as Spec>::K8Spec as K8Spec>::Status:  Default + Debug + Serialize + DeserializeOwned + Clone + Send
    ...
    async fn inner_process<S>(&self,action: WSAction<S>) -> Result<(), ScServerError> 
        ...
        where 
            ...
            <<S as Spec>::K8Spec as K8Spec>::Status: From<S::Status> + Clone + Default + Debug + Serialize + DeserializeOwned + Send + Sync
...
impl WSUpdateService for K8WSUpdateService {
    ...
    async fn update_partition(&self,ws_actions: WSAction<PartitionSpec>) -> Result<(), ScServerError> {
