...
- Add througput control to fluvio producer ([#2512](https://github.com/infinyon/fluvio/issues/2512))
- Add dependency checks and reporting ([#2564](https://github.com/infinyon/fluvio/issues/2564))
- Add conventional commit check on PR title ([#2565](https://github.com/infinyon/fluvio/issues/2565))
- Add labels to dependabot ([#2574](https://github.com/infinyon/fluvio/issues/2574))
- Add wait for SC availability ([#2566](https://github.com/infinyon/fluvio/issues/2566))
- Added blocking if the batch queue is full ([#2562](https://github.com/infinyon/fluvio/issues/2562))
- Add to instructions for building docker image ([#2582](https://github.com/infinyon/fluvio/issues/2582))
- Minor updates to doc/DEVELOPER.md ([#2585](https://github.com/infinyon/fluvio/issues/2585))
- Rationalize smart-module dependencies ([#2579](https://github.com/infinyon/fluvio/issues/2579))
- Added error for init params failure ([#2600](https://github.com/infinyon/fluvio/issues/2600))
- SmartEngine API refactoring ([#2602](https://github.com/infinyon/fluvio/issues/2602))
- Initial support for SmartEngine v2 ([#2610](https://github.com/infinyon/fluvio/issues/2610))
- Support chaining ([#2618](https://github.com/infinyon/fluvio/issues/2618))
- Add cargo smart-module template ([#2623](https://github.com/infinyon/fluvio/issues/2623))
- Add SmartModule meta ([#2626](https://github.com/infinyon/fluvio/issues/2626))
- Add deprecation warning to `fluvio connector` cli command ([#2603](https://github.com/infinyon/fluvio/issues/2603))
- Initial smdk crate project ([#2632](https://github.com/infinyon/fluvio/issues/2632))
- Support to build `SmartModules` using `smdk build` ([#2638](https://github.com/infinyon/fluvio/issues/2638))
- SmartModule Load Phase 1 ([#2639](https://github.com/infinyon/fluvio/issues/2639))
- Loading SmartModule Package Id resolution ([#2645](https://github.com/infinyon/fluvio/issues/2645))
- Add extraContainers option to pods ([#2653](https://github.com/infinyon/fluvio/issues/2653))
- Add fluvio hub util ([#2649](https://github.com/infinyon/fluvio/issues/2649))
- Add fluvio sm download ([#2656](https://github.com/infinyon/fluvio/issues/2656))
- Support to generate action tokens in other environments ([#2687](https://github.com/infinyon/fluvio/issues/2687))
- Refactor fluvio cli for hub ([#2688](https://github.com/infinyon/fluvio/issues/2688))
- Add K8 FQDN for SPU endpoints ([#2691](https://github.com/infinyon/fluvio/issues/2691))
- Short circuit wait for metadata ([#2689](https://github.com/infinyon/fluvio/issues/2689))
- Developer help ([#2681](https://github.com/infinyon/fluvio/issues/2681))
- 2652 add p package option to smdk to support cargo workspace projects ([#2701](https://github.com/infinyon/fluvio/issues/2701))
- General admin watch API ([#2706](https://github.com/infinyon/fluvio/issues/2706))
- Expose all public members from `hubaccess` module ([#2710](https://github.com/infinyon/fluvio/issues/2710))
- Update release artifact make ([#2712](https://github.com/infinyon/fluvio/issues/2712))
- Go through Makefile and replace all subst ([#2713](https://github.com/infinyon/fluvio/issues/2713))
- More smdk metadata paths ([#2716](https://github.com/infinyon/fluvio/issues/2716))
- Fluvio-cli, fluvio hub list, add SMARTMODULES column header ([#2697](https://github.com/infinyon/fluvio/issues/2697))
- `PackageMeta` fully qualified ID support ([#2719](https://github.com/infinyon/fluvio/issues/2719))
- Add extraEnv to pod values ([#2718](https://github.com/infinyon/fluvio/issues/2718))
- Add instrumentation to client producer ([#2717](https://github.com/infinyon/fluvio/issues/2717))
- Added metrics to smartengine ([#2726](https://github.com/infinyon/fluvio/issues/2726))
- Add connector step in the README ([#2734](https://github.com/infinyon/fluvio/issues/2734))
- Add otel to consumer ([#2725](https://github.com/infinyon/fluvio/issues/2725))
- Add record counters to spu ([#2731](https://github.com/infinyon/fluvio/issues/2731))
- Metric endpoint ([#2737](https://github.com/infinyon/fluvio/issues/2737))
- Add Client Metrics stats ([#2742](https://github.com/infinyon/fluvio/issues/2742))
- Fluvio hub util updates ([#2730](https://github.com/infinyon/fluvio/issues/2730))
- Add new API to load cluster config from default profile ([#2745](https://github.com/infinyon/fluvio/issues/2745))
- Add extra volumes and mounts to values ([#2747](https://github.com/infinyon/fluvio/issues/2747))

### CI

- Post 0.9.33 release changes ([#2545](https://github.com/infinyon/fluvio/issues/2545))
- Implement Test Mode ([#2636](https://github.com/infinyon/fluvio/issues/2636))
- Generate SmartModules using SMDK ([#2630](https://github.com/infinyon/fluvio/issues/2630))
- Upgrade bug  ([#2643](https://github.com/infinyon/fluvio/issues/2643))
- Add smdk publish ([#2657](https://github.com/infinyon/fluvio/issues/2657))
- Add `smdk` install support in CLI and release ([#2648](https://github.com/infinyon/fluvio/issues/2648))
- Remove makefile env var check in CI ([#2659](https://github.com/infinyon/fluvio/issues/2659))
- Enable fast fail for smoke test ([#2663](https://github.com/infinyon/fluvio/issues/2663))
- Update clap to v4 ([#2670](https://github.com/infinyon/fluvio/issues/2670))
- Smdk hub cli updates ([#2733](https://github.com/infinyon/fluvio/issues/2733))

### Changed

- Extend SmartModule CRD with new Package definition ([#2538](https://github.com/infinyon/fluvio/issues/2538))
- Upgrade to latest version ([#2560](https://github.com/infinyon/fluvio/issues/2560))
- (docs) Update --sys-only flag in k8-util/helm/README.md ([#2556](https://github.com/infinyon/fluvio/issues/2556))
- Update dependencies ([#2606](https://github.com/infinyon/fluvio/issues/2606))
- Update third party dependencies ([#2612](https://github.com/infinyon/fluvio/issues/2612))
- Update dependencies ([#2622](https://github.com/infinyon/fluvio/issues/2622))
- Update DEVELOPER doc ([#2654](https://github.com/infinyon/fluvio/issues/2654))
- Update third party dependencies ([#2655](https://github.com/infinyon/fluvio/issues/2655))

### Fixed

- (chore) fix broken ui test for fluvio-protocol-derive ([#2551](https://github.com/infinyon/fluvio/issues/2551))
- Add shared folder startup example ([#2554](https://github.com/infinyon/fluvio/issues/2554))
- Fix broken doc links ([#2547](https://github.com/infinyon/fluvio/issues/2547))
- Fix unused dependencies check ([#2588](https://github.com/infinyon/fluvio/issues/2588))
- Add check for pinned versions ([#2589](https://github.com/infinyon/fluvio/issues/2589))
- Remove dependency on POSIX coreutils #2597  ([#2604](https://github.com/infinyon/fluvio/issues/2604))
- Improve smart-module cli test ([#2608](https://github.com/infinyon/fluvio/issues/2608))
- Use `wait_time` by default in `StoreContext` ([#2609](https://github.com/infinyon/fluvio/issues/2609))
- Rewrite test-crate-version in Rust ([#2595](https://github.com/infinyon/fluvio/issues/2595))
- Link to running fluvio cluster using native binaries ([#2613](https://github.com/infinyon/fluvio/issues/2613))
- Provide keys for yaml example ([#2611](https://github.com/infinyon/fluvio/issues/2611))
- Smdk set-hubid from clean state ([#2662](https://github.com/infinyon/fluvio/issues/2662))
- Fix deleting SmartModule with package ([#2665](https://github.com/infinyon/fluvio/issues/2665))
- Smdk publish, misc small updates ([#2666](https://github.com/infinyon/fluvio/issues/2666))
- Fixed failure if sm chain is empty ([#2669](https://github.com/infinyon/fluvio/issues/2669))
- Fluvio sm download, look for any Smartmodule toml file in package ([#2671](https://github.com/infinyon/fluvio/issues/2671))
- Fix unused deps check ([#2673](https://github.com/infinyon/fluvio/issues/2673))
- Fluvio sm download, detection of some smartmodule meta file names in package ([#2672](https://github.com/infinyon/fluvio/issues/2672))
- Fix downloading SmartModule from Hub ([#2675](https://github.com/infinyon/fluvio/issues/2675))
- Smdk generate template ([#2677](https://github.com/infinyon/fluvio/issues/2677))
- Clap group only happens in debug ([#2708](https://github.com/infinyon/fluvio/issues/2708))
- Replaces custom llvm install script with action ([#2715](https://github.com/infinyon/fluvio/issues/2715))
- Validate empty group name ([#2721](https://github.com/infinyon/fluvio/issues/2721))
- Display fqdn to CLI ([#2723](https://github.com/infinyon/fluvio/issues/2723))
- Add non-interactive `smdk generate` flow ([#2693](https://github.com/infinyon/fluvio/issues/2693))
- Smdk set-hubid -> smdk hub id ([#2711](https://github.com/infinyon/fluvio/issues/2711))
- Fluvio-hub and smdk hub related cmds ([#2724](https://github.com/infinyon/fluvio/issues/2724))
- Remove println in spu ([#2744](https://github.com/infinyon/fluvio/issues/2744))
- Use `localhost` as `proxy-addr` for k8s cluster on macOS ([#2740](https://github.com/infinyon/fluvio/issues/2740))
- Add prompt for project group in `smdk generate` ([#2746](https://github.com/infinyon/fluvio/issues/2746))
- Initialize monitoring before proxy creation ([#2749](https://github.com/infinyon/fluvio/issues/2749))

### Other

- Improve error messages ([#2563](https://github.com/infinyon/fluvio/issues/2563))
- Dependabot check major version only ([#2575](https://github.com/infinyon/fluvio/issues/2575))
- Use dynamic local port for k8 port forwarding ([#2578](https://github.com/infinyon/fluvio/issues/2578))
- Specify installation for rust ([#2515](https://github.com/infinyon/fluvio/issues/2515))
- Upgrade wasm-time to 0.40.0 ([#2587](https://github.com/infinyon/fluvio/issues/2587))
- `CONTRIBUTING` link to architecture overview ([#2596](https://github.com/infinyon/fluvio/issues/2596))
- Upgrade bats to 1.7.0 ([#2607](https://github.com/infinyon/fluvio/issues/2607))
- Upgrade to wasmtime 1.0.0 ([#2614](https://github.com/infinyon/fluvio/issues/2614))
- Consolidate SmartModule derive ([#2619](https://github.com/infinyon/fluvio/issues/2619))
- Renaming regex ([#2661](https://github.com/infinyon/fluvio/issues/2661))
- Public scope for package related symbols ([#2698](https://github.com/infinyon/fluvio/issues/2698))
- Exclude md ([#2705](https://github.com/infinyon/fluvio/issues/2705))
- Upgrade to version 10.0.0-alpha ([#2709](https://github.com/infinyon/fluvio/issues/2709))
- `HubAccess` list action tokens ([#2707](https://github.com/infinyon/fluvio/issues/2707))
- Producer stat ([#2743](https://github.com/infinyon/fluvio/issues/2743))
