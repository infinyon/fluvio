...
* Add a `size` field in the `fluvio partition list` output. This field represents the size of logs in the partition. ([#2214](https://github.com/infinyon/fluvio/pull/2214))
