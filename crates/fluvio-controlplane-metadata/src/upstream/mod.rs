...
mod metadata {
    ...
    impl Spec for UpstreamSpec {
        const LABEL: &'static str = "Upstream";
        type IndexKey = String;
        type Status = UpstreamStatus;
        type Owner = Self;
    }

    impl SpecExt for UpstreamSpec {
        const OBJECT_TYPE: ObjectType = ObjectType::Upstream;
    }
    ...
    mod extended {
        ...
        use super::metadata::UpstreamSpec;

        impl K8ExtendedSpec for UpstreamSpec {
            type K8Spec = Self;
