...
pub fn generate_filter_smartstream(func: &SmartStreamFn, has_params: bool) -> TokenStream {
    ...
    quote! {
        ...
        mod __system {
            ...
            pub unsafe fn filter(ptr: *mut u8, len: usize) -> i32 {
                ...
                if let Err(_err) = Decoder::decode(&mut smartstream_input, &mut std::io::Cursor::new(input_data), fluvio_smartmodule::api_versions::WASM_MODULE_V2_API) {
