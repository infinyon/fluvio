...
pub fn impl_smart_opt(input: DeriveInput) -> syn::Result<TokenStream> {
    ...
    let gen = quote! {
        impl #impl_generics std::convert::TryFrom<fluvio_smartmodule::dataplane::smartstream::SmartModuleExtraParams
        > for #name #ty_generics #where_clause {
            type Error =  String;
                fn  try_from(params: fluvio_smartmodule::dataplane::smartstream::SmartModuleExtraParams) -> ::std::result::Result<Self, Self::Error>{
